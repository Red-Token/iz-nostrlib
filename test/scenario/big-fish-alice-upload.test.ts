...
import {Followee, Nip02FollowListEvent} from '../../src/org/nostr/nip02/index.js'
...
import {CommunityNostrContext} from '../../src/org/nostr/communities/CommunityNostrContext.js'
...
import {Nip78ArbitraryCustomAppData} from '../../src/org/nostr/nip78/Nip78ArbitraryCustomAppData.js'
import {AppNostrContext} from '../../src/org/nostr/communities/AppNostrContext.js'
import {Client} from 'ssh2'
import * as fs from 'node:fs'
import {DynamicSynchronisedSession} from '../../src/org/nostr/ses/DynamicSynchronisedSession.js'
import {Nip35TorrentEvent, Nip35TorrentEventHandler} from '../../src/org/nostr/nip35/Nip35TorrentEvent.js'
import {DynamicSubscription} from '../../src/org/nostr/ses/DynamicSubscription.js'
import {StaticEventsProcessor} from '../../src/org/nostr/ses/StaticEventsProcessor.js'
import {asyncCreateWelshmanSession, Identifier, Identity} from '../../src/org/nostr/communities/Identity.js'
...
describe('Alice uploads a movie to Big Fish', () => {
    ...
    it('Big Fish', async () => {
        ...
        const readTestAppData =
            (aliceAppContext.appDataService.appDataMap.get(aliceIdentifier.pubkey)?.get(appName)
                ?.data as TestAppData) ?? new TestAppData()
        ...
        const aliceBigFishSubscription = new DynamicSubscription(aliceBigFishSession, [
        ...
        // Update Bobs profile
        const bobMetaDataEvent = new Nip01UserMetaDataEvent(
            new NostrUserProfileMetaData('Bob', 'The King of Tests', 'bob.jpg')
        )
